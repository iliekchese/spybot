...
client.on('guildMemberAdd', async member => {
	const image = await drawCard({
		...
		background:
			'https://images.unsplash.com/photo-1456154875099-97a3a56074d3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fHVuaXZlcnNlfGVufDB8fDB8fA%3D%3D&w=1000&q=80',
		blur: 1,
		border: true,
		rounded: true,
	});
