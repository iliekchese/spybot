...
var punish = function (member, reason, guild) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                punish = _b.sent();
                _a = punish === null || punish === void 0 ? void 0 : punish.option;
                switch (_a) {
                ...
                return [3, 9];
            case 3: return [4, (member === null || member === void 0 ? void 0 : member.kick(reason))];
            case 4:
                _b.sent();
                return [3, 9];
            case 5: return [4, (member === null || member === void 0 ? void 0 : member.ban({ reason: reason }))];
            case 6:
                _b.sent();
                return [3, 9];
            case 7:
            ...
            case 8:
                ...
                return [3, 9];
            case 9: return [2, punish === null || punish === void 0 ? void 0 : punish.option];
        }
    });
}); };
