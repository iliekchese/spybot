			...
			return __generator(this, function (_k) {
				switch (_k.label) {
					case 0:
						return [
							4,
							database_1.prisma.whitelist.findUnique({
								where: {
									guild:
					...
					case 2:
						...
						if (
							whitelist === null || whitelist === void 0
								? void 0
								: whitelist.users.some(function (id) {
										return id === user.id;
								  })
						) {
						...
						return [
							4,
							database_1.prisma.whitelist.upsert({
					...
					case 4:
						...
						if (
							!((_d =
								whitelist === null || whitelist === void 0
									? void 0
									: whitelist.users) === null || _d === void 0
								? void 0
								: _d.find(function (id) {
										return (
											id ===
						...
						return [
							4,
							database_1.prisma.whitelist.update({
								where: { guild: message.guildId },
								data: {
									users: whitelist.users.filter(function (id) {
										return (
											id !==
											(user === null || user === void 0 ? void 0 : user.id)
										);
							...
							.setFooter({
								text:
									(_e = message.guild) === null || _e === void 0
										...
										: _e.name,
								iconURL:
									(_f = message.guild) === null || _f === void 0
										? void 0
										: _f.iconURL(),
							})
							.setThumbnail(
								(_g = message.guild) === null || _g === void 0
									? void 0
									: _g.iconURL()
							);
						whitelisted =
							(_h =
								whitelist === null || whitelist === void 0
									? void 0
									: whitelist.users) === null || _h === void 0
								? void 0
								: _h.map(function (id) {
										return '<@'.concat(id, '>');
								  });
						if (
							whitelisted === null || whitelisted === void 0
								? void 0
								: whitelisted.length
						) {
