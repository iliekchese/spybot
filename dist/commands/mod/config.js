			...
			return __generator(this, function (_o) {
				switch (_o.label) {
					...
					case 3:
						...
						show = new discord_js_1.MessageEmbed()
							...
							.addField(
								'Punishment',
								(_e =
									punish === null || punish === void 0
										? void 0
										: punish.option) !== null && _e !== void 0
									? _e
									: disabled
							)
							.setColor('GREEN');
					...
					case 4:
						...
						return [
							4,
							database_1.prisma.punish.upsert({
								where: { guild: message.guildId },
					...
					case 6:
						if (
							!((_g = message.member) === null || _g === void 0
								? void 0
								: _g.permissions.has(
										discord_js_1.Permissions.FLAGS.ADMINISTRATOR
								  ))
						...
						if (
							channel_1.guild.id !==
							((_h = message.guild) === null || _h === void 0 ? void 0 : _h.id)
						) {
							message.channel.send(
						...
						return [
							4,
							database_1.prisma.logsChannel.upsert({
								where: { guild: message.guildId },
					...
					case 8:
						helpEmbed = new discord_js_1.MessageEmbed()
							...
							.setFooter({
								text:
									(_j = message.guild) === null || _j === void 0
										? void 0
										: _j.name,
								iconURL:
									(_k = message.guild) === null || _k === void 0
										? void 0
										: _k.iconURL(),
							});
					...
					case 9:
						return [
							4,
							(_l = message.guild) === null || _l === void 0
								? void 0
								: _l.channels.fetch(
										logs === null || logs === void 0 ? void 0 : logs.id
								  ),
