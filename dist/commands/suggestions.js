...
exports.default = {
    ...
    run: function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _d, channel, embed, suggestions, suggestionsChannel;
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4, database_1.prisma.suggestionsChannel.create({
                                data: { guild: (_c = message.guild) === null || _c === void 0 ? void 0 : _c.id, channel: channel.id },
                            })];
                    case 2:
                        _e.sent();
                    ...
                    case 4:
                        ...
                        suggestionsChannel = client.channels.cache.get(suggestions === null || suggestions === void 0 ? void 0 : suggestions.channel);
