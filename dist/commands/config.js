                ...
                switch (_o.label) {
                    ...
                    case 3:
                        ...
                        show = new discord_js_1.MessageEmbed()
                            ...
                            .addField('Logs: ', (logs === null || logs === void 0 ? void 0 : logs.channel) ? "<#".concat(logs.channel, ">") : disabled, false)
                            .addField('Punishment: ', (_e = punish === null || punish === void 0 ? void 0 : punish.option) !== null && _e !== void 0 ? _e : disabled, false)
                            .setColor('GREEN');
                    ...
                    case 8:
                        ...
                        return [3, 9];
                    case 9: return [4, ((_l = message.guild) === null || _l === void 0 ? void 0 : _l.channels.fetch(logs === null || logs === void 0 ? void 0 : logs.channel))];
                    case 10:
                        channel = _o.sent();
                        if (!channel) {
